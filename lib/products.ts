...
export const collections = [
  {
    ...
    description: 'Notas profundas, mapas y comentarios para iluminar cada pasaje.',
  },
  {
    slug: 'journaling-bibles',
    name: 'Biblias de Diario',
    description: 'Amplios márgenes para reflexionar, ilustrar y responder a la Palabra.',
  },
  {
    slug: 'large-print-bibles',
    name: 'Biblias de Letra Grande',
    description: 'Tipografía generosa y legible para una lectura cómoda y pausada.',
  },
  {
    slug: 'gift-editions',
    name: 'Ediciones de Regalo',
    description: 'Ediciones acabadas con cuidado, hechas para atesorar y regalar.',
  },
  {
    slug: 'premium-leather',
    name: 'Biblias de Cuero Premium',
    description: 'Cuero de calidad de herencia, encuadernado para durar toda una vida de devoción.',
  },
]

export const translations = ['ESV', 'NIV', 'KJV', 'NKJV', 'NLT', 'CSB']
export const formats = ['Tapa Dura', 'Cuero', 'Tela', 'Compacto']
export const coverTypes = ['Cuero Genuino', 'Cuero Aglutinado', 'Tela', 'Tapa Dura']
...
export const products: Product[] = [
  ...
  },
  {
    ...
    shortDescription: 'Cuero tono arena con amplios márgenes rayados para reflexión.',
    description:
  ...
  },
  {
    ...
    shortDescription: 'Tapa dura de tela marfil con extensas notas de estudio y mapas.',
    description:
  ...
  },
  {
    ...
    shortDescription: 'Cuero carbón con generosa tipografía de 14pt y bordes dorados.',
    description:
  ...
  },
  {
    ...
    shortDescription: 'Edición de regalo azul océano con detalles dorados y cinta.',
    description:
  ...
  },
  {
    ...
    language: 'Inglés',
    edition: 'Edición de Estudio',
    shortDescription: 'Cuero aglutinado azul marino con ayudas devocionales de estudio.',
    description:
  ...
  },
  {
    ...
    language: 'Bilingüe',
    edition: 'Diario',
    shortDescription: 'Edición de diario en tela con indicaciones de ilustración.',
    description:
